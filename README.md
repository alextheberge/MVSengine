...
- When `workspace_only` follows `package.json` conditions, it prefers `types`, then `import`, `module`, `browser`, `node`, `default`, and `require`; any remaining custom conditions are tried after that in key order
