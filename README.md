...
- TypeScript or JavaScript repos with `package.json` export maps, `imports` maps, or `tsconfig`/`jsconfig` path aliases inside the same workspace: set `ts_export_following` to `workspace_only`
