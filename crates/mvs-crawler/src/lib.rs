...
use mvs_core::manifest::{GoExportFollowing, RustExportFollowing, ScanPolicy};
    ...
    for file in source_files {
        ...
        for signature in signatures {
            let item_decision = if file_decision.included {
                ...
                mvs_core::manifest::PublicApiItemFilterDecision {
                    included: false,
...
mod tests {
    ...
    use mvs_core::manifest::ScanPolicy;
    ...
    fn rust_export_following_public_modules_expands_rooted_lib_rs_across_public_modules() {
        ...
        let default_report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                ts_export_following: mvs_core::manifest::TsExportFollowing::Off,
                go_export_following: mvs_core::manifest::GoExportFollowing::Off,
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Heuristic,
        ...
        let followed_report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                ts_export_following: mvs_core::manifest::TsExportFollowing::Off,
                go_export_following: mvs_core::manifest::GoExportFollowing::Off,
                rust_export_following: mvs_core::manifest::RustExportFollowing::PublicModules,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Heuristic,
                python_module_roots: Vec::new(),
    ...
    fn ts_export_following_relative_only_resolves_barrel_reexports() {
        ...
        let followed_report = crawl_codebase(
            ...
            &ScanPolicy {
                exclude_paths: Vec::new(),
                public_api_roots: vec!["src/index.ts".to_string()],
                ts_export_following: mvs_core::manifest::TsExportFollowing::RelativeOnly,
                go_export_following: mvs_core::manifest::GoExportFollowing::Off,
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
    ...
    fn ts_export_following_workspace_only_resolves_package_exports_and_tsconfig_paths() {
        ...
        let workspace_report = crawl_codebase(
            ...
            &ScanPolicy {
                exclude_paths: Vec::new(),
                public_api_roots: vec!["src/index.ts".to_string()],
                ts_export_following: mvs_core::manifest::TsExportFollowing::WorkspaceOnly,
                go_export_following: mvs_core::manifest::GoExportFollowing::Off,
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
    ...
    fn go_export_following_package_only_expands_file_roots_to_same_package_siblings() {
        ...
        let package_report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                public_api_roots: vec!["src/api.go".to_string()],
                ts_export_following: mvs_core::manifest::TsExportFollowing::Off,
                go_export_following: mvs_core::manifest::GoExportFollowing::PackageOnly,
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Heuristic,
    ...
    fn python_export_following_off_disables_cross_module_workspace_resolution() {
        ...
        let report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Off,
                python_module_roots: vec!["app".to_string()],
                rust_workspace_members: Vec::new(),
                public_api_includes: Vec::new(),
                public_api_excludes: Vec::new(),
    ...
    fn ruby_export_following_off_keeps_file_local_visibility_without_macro_promotion() {
        ...
        let off_report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                go_export_following: mvs_core::manifest::GoExportFollowing::Off,
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Off,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Heuristic,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Heuristic,
                python_module_roots: Vec::new(),
                rust_workspace_members: Vec::new(),
    ...
    fn lua_export_following_off_disables_returned_root_module_following() {
        ...
        let report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::Off,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Heuristic,
                python_module_roots: Vec::new(),
                rust_workspace_members: Vec::new(),
                public_api_includes: Vec::new(),
    ...
    fn lua_export_following_returned_root_only_requires_runtime_return_boundary() {
        ...
        let report = crawl_codebase(
            ...
            &ScanPolicy {
                ...
                rust_export_following: mvs_core::manifest::RustExportFollowing::Off,
                ruby_export_following: mvs_core::manifest::RubyExportFollowing::Heuristic,
                lua_export_following: mvs_core::manifest::LuaExportFollowing::ReturnedRootOnly,
                python_export_following: mvs_core::manifest::PythonExportFollowing::Heuristic,
                python_module_roots: Vec::new(),
                rust_workspace_members: Vec::new(),
                public_api_includes: Vec::new(),
